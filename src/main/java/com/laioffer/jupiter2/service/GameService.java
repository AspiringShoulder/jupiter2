...
import com.laioffer.jupiter2.entity.db.ItemType;
...
import com.laioffer.jupiter2.entity.response.Game;
...
{
    private static final String TOKEN = "Bearer 1yi7r8clbr3vimu5s913z0rpsn4hi5";
    private static final String CLIENT_ID = "7es4lznblf83jp5kwitydiepx9mx6a";
